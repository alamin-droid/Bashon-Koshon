            ...
            <div class="card">
                <div class="card-body">
                    <div class="row table-responsive">
                        <div class="col-md-12">
                            <h4 class="text-center">কর্মচারী হাজিরা খাতা | তারিখ : {{date('d-m-Y')}}<hr/></h4>
                            <table class="table table-striped">
                                ...
                                @forelse($employees as $employee)
                                    <tr class="text-center">
                                        ...
                                        <td><input type="text" class="form-control total_time" id="total_{{$employee->id}}" name="total_time[]" readonly></td>
