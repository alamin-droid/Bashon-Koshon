@extends('master')
@section('content')
    {!! Form::open(['class' =>'form-sample','route' => ['payment.update', $payment->id],'method' => 'PATCH']) !!}
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-pencil"></i></span> আপডেট পেমেন্ট</h3></div>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="supplier_id" id="supplier_id" >
                            ...
                            @foreach($suppliers as $supplier)
                                <option value="{{$supplier->id}}" @if($payment->supplier_id == $supplier->id) selected @endif>{{$supplier->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="due_amount">বকেয়া টাকা</label>
                        <input type="number" class="form-control" id="due_amount" name="due_amount" value="{{$payment->due_amount}}" readonly required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="mode_of_payment" id="mode_of_payment">
                            <option selected disabled value="">choose an option</option>
                            <option value="bank" @if($payment->mode_of_payment == 'bank') selected @endif>Bank</option>
                            <option value="cash" @if($payment->mode_of_payment == 'cash') selected @endif>Cash</option>
                        </select>
                    </div>
                    <div class="form-group" id="bank_id_field" @if($payment->mode_of_payment == 'cash') style="display: none" @endif >
                        <label for="bank_account">ব্যাংক</label>
                        <select class="form-control" name="bank_account" id="bank_account">
                            <option selected disabled value="">choose an option</option>
                            @foreach($banks as $bank)
                                <option value="{{$bank->account}}" @if($payment->mode_of_payment_name == $bank->account) selected @endif>{{$bank->account}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="overview_mode_of_payment" name="overview_mode_of_payment" value="{{$payment->mode_of_payment}}" readonly required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="debit_amount">েবিট টাকার পরিমান</label>
                                <input type="text" class="form-control" id="debit_amount" name="debit_amount" value="{{$payment->debit_amount}}" readonly required>
                            </div>
                        </div>
                        <div class="col-md-3"></div>
                        <div class="col-md-3"></div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="mode_of_payment_name" name="mode_of_payment_name" value="{{$payment->mode_of_payment_name}}" readonly required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="credit_amount" name="credit_amount" value="{{$payment->credit_amount}}" readonly required>
                            </div>
                        </div>
                    </div>
                </div>
