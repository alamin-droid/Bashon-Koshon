...
@section('content')
    @php
        $i = 0;
    @endphp
    {!! Form::open(['class' =>'form-sample','route' => ['shooter.update', $edit->id],'method' => 'PATCH']) !!}
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="before_shooter_qty" id="before_shooter_qty" value="{{$edit->before_shooter_qty}}" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="after_shooter_qty">চালের বস্তা প্রদান</label>
                                    <input type="text" class="form-control" name="after_shooter_qty" id="after_shooter_qty" value="{{$edit->after_shooter_qty}}" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="shooter_price_per_bag">মূল্য/বস্তা</label>
                                    <input type="text" class="form-control" name="shooter_price_per_bag" id="shooter_price_per_bag" value="{{$edit->shooter_price_per_bag}}"  required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="shooter_total_price">মোট শ্যুটার মুল্য</label>
                                    <input type="text" class="form-control" name="shooter_total_price" id="shooter_total_price" value="{{$edit->shooter_total_price}}" readonly required>
                                </div>
                            </div>
                            @for($i = 0 ; $i<count($edit->excess_item) ;$i++)
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control excess_item" name="excess_item[]" id="excess_item_{{$i}}">
                                        ...
                                        @foreach($finished_goods as $finished_good)
                                            <option value="{{$finished_good->id}}" @if($edit->excess_item[$i] == $finished_good->id) selected @endif>{{$finished_good->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
