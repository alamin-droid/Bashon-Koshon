...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-account"></i></span>নতুন গ্রাহক</h3></div>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="c_person" name="c_person" placeholder="Contact Person" required>
                    </div>
                </div>
            </div>
        </div>
