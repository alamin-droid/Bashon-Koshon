                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="bag_price" name="bag_price" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="total_bag_price">মোট ছালার মূল্য</label>
                                <input type="number" class="form-control" id="total_bag_price" name="total_bag_price" readonly required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
