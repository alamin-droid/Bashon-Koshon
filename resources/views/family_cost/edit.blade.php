@extends('master')
@section('content')
    {!! Form::open(['class' =>'form-sample','route' => ['family_cost.update', $edit->id],'method' => 'PATCH']) !!}
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-currency-usd"></i></span>পারিবারিক খরচ</h3></div>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="item" name="item"  value="{{$edit->cost_for}}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row text-center" id="overview1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="item_name" name="item_name" value="{{$edit->cost_for}}" readonly>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
