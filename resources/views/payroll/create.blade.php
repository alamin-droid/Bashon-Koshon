...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-account"></i></span>বেতন-ভাতা</h3></div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="overtime_time" name="overtime_time" readonly>
                        </div>
                        <div class="form-group">
                            <label for="overtime_amount">ওভারটাইম পারিশ্রমিক/ঘন্টা</label>
                            <input type="number" class="form-control" id="overtime_amount" name="overtime_amount" placeholder="place overtime amount per hour for this employee">
                        </div>
                        <div class="form-group">
                            <label for="overtime">ওভারটাইম পারিশ্রমিক</label>
                            <input type="number" class="form-control" id="overtime" name="overtime" readonly>
                        </div>
                        <div class="form-group">
                            <label for="salary_deduction" >বেতন কর্তন</label>
                            <input type="number" class="form-control" id="salary_deduction" name="salary_deduction" placeholder="Salary deducted in this month">
                        </div>
                        <div class="form-group">
