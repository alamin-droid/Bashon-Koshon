                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="collection_for" id="collection_for" required>
                            ...
                            <option value="client" @if(!empty($collection->client_id)) selected @endif>Dealer</option>
                            <option value="retail" @if(!empty($collection->retail_sell)) selected @endif>Retailer</option>
                        </select>
                    </div>
                    <div class="form-group" id="client_id_field" @if(empty($collection->client_id))style="display: none" @endif>
                        <label for="clients">গ্রাহক</label>
                        <select class="form-control" name="client_id" id="client_id" >
                            <option selected disabled value="">choose an option</option>
                            @foreach($clients as $client)
                                <option value="{{$client->id .'_'.$client->name}}" @if($collection->client_id == $client->id) selected @endif>{{$client->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group" id="retail_sell_field" @if(empty($collection->retail_sell))style="display: none" @endif>
                        <label for="retail_sell"> খুচরা গ্রাহক </label>
                        <input type="text" class="form-control" id="retail_sell" name="retail_sell" value="{{$collection->retail_sell}}" >
                    </div>
                    <div class="form-group">
                        <label for="amount"> টাকার পরিমান </label>
                        <input type="number" class="form-control payment" id="amount" name="amount" placeholder="10,000 /-" value="{{$collection->amount}}" required>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" name="mode_of_payment_received" id="mode_of_payment_received" required>
                            <option selected disabled value="">choose an option</option>
                            <option value="bank" @if($collection->mode_of_payment == 'bank') selected @endif>Bank</option>
                            <option value="cash" @if($collection->mode_of_payment == 'cash') selected @endif>Cash</option>
                        </select>
                    </div>
                    <div class="form-group" id="bank_id_field" @if($collection->mode_of_payment == 'cash') style="display: none" @endif>
                        <label for="bank_account">ব্যাংক</label>
                        <select class="form-control" name="bank_account" id="bank_account">
                            <option selected disabled value="">choose an option</option>
                            @foreach($banks as $bank)
                                <option value="{{$bank->account}}" @if($collection->mode_of_payment_name == $bank->account) selected @endif>{{$bank->account}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="mode_of_payment_name" name="mode_of_payment_name" value="{{$collection->mode_of_payment_name}}" readonly>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="debit_amount" name="debit_amount" value="{{$collection->debit_amount}}" readonly>
                            </div>
                        </div>
                        <div class="col-md-3"></div>
                        <div class="col-md-3"></div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="client_name" name="client_name" value="{{$collection->client_name}}" readonly>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="credit_amount" name="credit_amount" value="{{$collection->credit_amount}}" readonly>
                            </div>
                        </div>
                    </div>
                </div>
